            ...
            fetch(`https://api-colombia.com/api/v1/Department/${departmentId}/cities`)
                ...
                .then(cities => {
                    ...
                    cities.forEach(city => {
                        ...
                        cityCard.classList.add('col-md-4', 'card', 'mb-4', 'shadow-sm', 'me-3', 'ms-3'); // Espaciado adicional
                ...
                .then(attractions => {
                    ...
                    if (filteredAttractions.length === 0) {
                        ...
                        filteredAttractions.forEach(attraction => {
                            ...
                            attractionCard.classList.add('col-md-4', 'card', 'mb-4', 'shadow-sm', 'me-3', 'ms-3'); // Espaciado adicional
